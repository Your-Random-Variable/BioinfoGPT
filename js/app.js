...
(() => {
  ...
  const tools={
    ...
    dotplot(){
      ...
      const res=BIO.dotPlot(s1,s2,win,thr); const out=$("#toolExtraOut") || $("#dotOut"); const canvas=$("#dotCanvas");
      if(!out) return;
